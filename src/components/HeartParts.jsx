...
const HeartParts = ({ title, description, image, index, onClickHandler, parentIndex = 0 }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 flex flex-col ${isEven ? "justify-end" : "justify-start"} p-8 bg-gradient-to-t from-black/70 to-transparent`} style={{ textShadow: "0 0 14px black" }}>
