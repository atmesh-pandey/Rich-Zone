...
{/* Left Content */}
<div className="flex flex-col text-white space-y-12 w-full lg:max-w-[45%] pl-8 lg:pl-0">
  <h1 className="text-3xl md:text-4xl lg:text-7xl font-bold text-center lg:text-left">
    Our Advantage
  </h1>

  {[
    "World's No 1 filler masterbatch import-export",
    ...
    <div key={index} className="flex items-start gap-4">
      ...
      <p className="text-base md:text-lg">{point}</p>
        ...
        {/* text-3xl md:text-4xl lg:text-7xl font-bold text-center lg:text-left */}
